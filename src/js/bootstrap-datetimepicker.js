            ...
            $("<tr>")
              .append(
                $("<th>")
                  ...
                  .append(
                    $("<span class='fas'>").addClass(options.icons.previous)
                  )
              )
              .append(
                $("<th>")
              ...
              .append(
                $("<th>")
                  ...
                  .append($("<span class='fas'>").addClass(options.icons.next))
              )
          ),
          ...
          topRow.append(
            $("<td>").append(
              $("<a>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.up))
            )
          );
          middleRow.append(
            $("<td>").append(
          ...
          bottomRow.append(
            $("<td>").append(
              $("<a>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.down))
            )
          );
        }
        if (isEnabled("m")) {
          ...
          row.push(
            $("<td>").append(
              $("<a>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.today))
            )
          );
        }
          ...
          row.push(
            $("<td>").append(
              $("<a class='d-inline-block w-100'>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.time))
            )
          );
        }
          ...
          row.push(
            $("<td>").append(
              $("<a>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.clear))
            )
          );
        }
          ...
          row.push(
            $("<td>").append(
              $("<a>")
                ...
                .append($("<span class='fas'>").addClass(options.icons.close))
            )
          );
        }
        return $("<table>")
        ...
        togglePicker: function (e) {
          ...
          if (expanded && expanded.length) {
            ...
            if (expanded.collapse) {
              ...
              expanded.toggleClass("hide show");
              expanded.removeClass("in");
              closed.addClass("in");
            }
            if ($this.is("svg")) {
              if (expanded.children(".datepicker").length > 0) {
                let $svgTime = $(`svg.${options.icons.time}`);
                $svgTime.removeClass(options.icons.time);
                $svgTime.addClass(options.icons.date);
              } else {
                let $svgDate = $(`svg.${options.icons.date}`);
                $svgDate.removeClass(options.icons.date);
                $svgDate.addClass(options.icons.time);
              }
            } else {
              if (expanded.children(".datepicker").length > 0) {
                let $svgTime = $(`svg.${options.icons.time}`);
